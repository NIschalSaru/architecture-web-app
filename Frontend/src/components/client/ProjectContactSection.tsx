...
const ProjectContactSection: React.FC = () => {
  ...
  const { postData, loading, error } = usePostAPI(
    "architecture-web-app/send-mail",
    false
    ...
    >
      <div className="container">
        <Row className="content-row">
          {/* <Col xs={28} md={12} lg={8} className="info-box"></Col> */}
            ...
            <div className="form-containerr">
              <Form form={form} layout="vertical" onFinish={onFinish}>
                ...
                <Button
                  type="primary"
                  htmlType="submit"
                  className="youtube-section__contact-buttonn"
                  loading={loading}
                >
                  Submit
                </Button>
